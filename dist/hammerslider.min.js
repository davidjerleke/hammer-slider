...
function HammerSlider(_this, options) {
  ...
  function setItemInfinitePosition(index, lastItemIndex, itemData) {
    ...
    var itemToPositionIndex = index ? 0 : lastItemIndex;
    var itemToPosition = itemData[itemToPositionIndex];
  ...
  function slideTo(direction, jumpTo) {
    ...
    if (typeof jumpTo === 'undefined') {
      ...
      var index = direction === -1 && (SLIDER.isLastSlide(currentSlideIndex) ? 0 : currentSlideIndex + 1);
      var distance = SLIDER.slideData[index || currentSlideIndex].distanceToNext;
