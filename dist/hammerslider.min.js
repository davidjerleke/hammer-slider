...
function HammerSlider(_this, options) {
  ...
  function getItemsInView() {
    ...
    var itemsToRight = getItemsInFraction(rightGapWidth, 1, SLIDER.lastSlideIndex);
  ...
  function setFlipData() {
    ...
    var resetPoint = getResetPoints(SLIDER.contentWidth, SLIDER.slideData[0]);
    mergeObjects(flipData, resetFlipIndex(flipData));
    mergeObjects(flipData, { resetPoint: resetPoint });
  ...
  function flip(position, direction) {
    ...
    if (direction === 1) {
      ...
      var intersectPoint = intersect(currentFlip.itemToFlipIndex, intersectItem);
      ...
      var _intersectPoint = intersect(currentFlip.itemToFlipIndex, intersectItem);
      if (!_intersectPoint) return;

      if (position > _intersectPoint) {
        var _itemPosition = flipItem.position - flipItem.distanceToFlip;
        setItemPosition(flipItem, _itemPosition);
